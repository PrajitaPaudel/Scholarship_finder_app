...
class AddStudentProfileView extends StatefulWidget {
  const AddStudentProfileView({super.key});

  @override
  State<AddStudentProfileView> createState() => _AddStudentProfileViewState();
}

class _AddStudentProfileViewState extends State<AddStudentProfileView> {
  ...
  void _onCreateButtonPressed(BuildContext context) {
    ...
    final studentProfileParams = CreateStudentProfileParams(
      userId: '',
    ...
    context.read<StudentProfileBloc>().add(
      CreateStudentProfileEvent(params: studentProfileParams),
    );
    _dispose();
  }
